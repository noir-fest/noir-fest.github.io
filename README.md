# Noir Fest 
This repository contains the code for NoirFest website, Noirfest API.
The api is built in Python and uses Falcon server


## The template used for landing page
